<?php
			...
			if($row["SIP_CONFIG_MODE"]=="LINE_MODE"){
				$row['sipserver'] = $row['SIP_CONTACT6_SERVER']."(L1)...";				
				$row['sipservertitle'] = "L1:".$row['SIP_CONTACT6_SERVER'];
				$row['sipid'] = $row['SIP_CONTACT6_LOGIN']."(L1)...";
				$row['sipidtitle'] = "L1:".$row['SIP_CONTACT6_LOGIN'];
