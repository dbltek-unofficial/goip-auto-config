<?php
			...
			if($_POST['sipserver'])
			{
				$sql.=",SIP_CONTACT0_SERVER=if(SIP_CONFIG_MODE ='LINE_MODE',SIP_CONTACT0_SERVER,'".$_POST['sipserver']."')";
				for($i=6;$i<$telport+6;$i++)
					$sql.=",SIP_CONTACT".$i."_SERVER=if(SIP_CONFIG_MODE ='LINE_MODE','".$_POST['sipserver']."',SIP_CONTACT".$i."_SERVER)";
			}
			if($_POST['sipproxy'])
			{
				$sql.=",SIP_CONTACT0_PROXY=if(SIP_CONFIG_MODE ='LINE_MODE',SIP_CONTACT0_PROXY,'".$_POST['sipproxy']."')";
				for($i=6;$i<$telport+6;$i++)
			...
			{
				$sql1.=",MG_RELAY_SERVER=if(MG_RELAY_SERVER!='".$_POST['rserver']."',MG_RELAY_SERVER,'".$_POST['relayserver']."')";				
			}
			if($_POST['relayport'])
			{
			...
			{
				$sql1.=",AUTOCFG_SERVER='".$_POST['auto_cfg_server']."'";
				$sql1.=",AUTOCFG='1'";
			}
			if($_POST['remote_control_server'])
			{
				$sql1.=",RADMIN_SERVER='".$_POST['remote_control_server']."'";
			}
