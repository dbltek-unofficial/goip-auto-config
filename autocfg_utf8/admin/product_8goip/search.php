<?php
	switch($show){
			...
			case "sipserver":
				...
				$sqlname.="'";*/
				$sqlname=" where ENDPOINT_TYPE='SIP' and ((SIP_CONFIG_MODE='SINGLE_MODE' and SIP_PROXY='".$sipserver."') or (SIP_CONFIG_MODE='LINE_MODE' and ( SIP_CONTACT0_SERVER='".$sipserver;
				for($i=1;$i<$telport;$i++)
					$sqlname.="' or SIP_CONTACT".$i."_SERVER='".$sipserver;				
				$sqlname.="')))";
				break;
