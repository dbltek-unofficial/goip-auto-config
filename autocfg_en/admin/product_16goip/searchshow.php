<?php
			...
			if($row["SIP_CONFIG_MODE"]=="LINE_MODE"){
				$row1['sipserver'] = $row['SIP_CONTACT6_SERVER']."(L1)...";				
				$row1['sipservertitle'] = "L1:".$row['SIP_CONTACT6_SERVER'];
				$row1['sipid'] = $row['SIP_CONTACT6_LOGIN']."(L1)...";
				$row1['sipidtitle'] = "L1:".$row['SIP_CONTACT6_LOGIN'];
				
				for($i=7,$k=1;$i<$row['TELPORT']+6;$i++,$k++){
					$j=$k+1;
