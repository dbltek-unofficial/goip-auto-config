...
/* 1p */
if($values['LIVELINE'] == 1):
  $values['STAR_CMD_START_VOIP_DIAL'] = $_POST['star_cmd_voip'] ;
  $updatesql.=",STAR_CMD_START_VOIP_DIAL='".$values['STAR_CMD_START_VOIP_DIAL']."'";
endif; 
if($values['LIVELINE'] == 1):
  $values['STAR_CMD_SWITCH_TO_PSTN'] = $_POST['star_cmd_pstn'] ;
  $updatesql.=",STAR_CMD_SWITCH_TO_PSTN='".$values['STAR_CMD_SWITCH_TO_PSTN']."'";
endif;  
if($values['LIVELINE'] == 1):
  $values['S_L1_DFC'] = $_POST['line1_default_mode'] ;
  $updatesql.=",S_L1_DFC='".$values['S_L1_DFC']."'";
endif; 
if($values['S_L1_DFC'] == 'PSTN'):
if($values['LIVELINE']==1 && $values['L1_VOIP_MATCHING_ENABLE']==1):
  $values['L1_VOIP_DIGITS'] = $_POST['line1_voip_digits'] ;
  $updatesql.=",L1_VOIP_DIGITS='".$values['L1_VOIP_DIGITS']."'";
endif; 
endif; 
if($values['LIVELINE']==1 && $values['TELPORT']>=2):
  $values['S_L2_DFC'] = $_POST['line2_default_mode'] ;
  $updatesql.=",S_L2_DFC='".$values['S_L2_DFC']."'";
endif; 
if($values['S_L2_DFC'] == 'PSTN'):
if($values['LIVELINE']==1 && $values['TELPORT']>=2 && $values['L2_VOIP_MATCHING_ENABLE']==1):
  $values['L2_VOIP_DIGITS'] = $_POST['line2_voip_digits'] ;
  $updatesql.=",L2_VOIP_DIGITS='".$values['L2_VOIP_DIGITS']."'";
endif; 
endif; 
if($values['LIVELINE']==1 && $values['TELPORT']>=3):
  $values['S_L3_DFC'] = $_POST['line3_default_mode'] ;
  $updatesql.=",S_L3_DFC='".$values['S_L3_DFC']."'";
endif; 
if($values['LIVELINE']==1 && $values['TELPORT']>=4):
  $values['S_L4_DFC'] = $_POST['line4_default_mode'] ;
  $updatesql.=",S_L4_DFC='".$values['S_L4_DFC']."'";
endif; 
if($values['LIVELINE']==1 && $values['TELPORT'] >= 2 && $values['HOOK_MODE']=='MULTI' && $values['PSTN_RING_LINE'] ):
  $values['L1_PSTN_RING'] = $_POST['line1_pstn_ring']=='on'?'1':'0';
  $updatesql.=",L1_PSTN_RING='".$values['L1_PSTN_RING']."'";
endif; 
if($values['LIVELINE']==1 && $values['TELPORT'] >= 2 && $values['HOOK_MODE']=='MULTI' && $values['PSTN_RING_LINE'] ):
  $values['L2_PSTN_RING'] = $_POST['line2_pstn_ring']=='on'?'1':'0';
  $updatesql.=",L2_PSTN_RING='".$values['L2_PSTN_RING']."'";
endif;  
if($values['LIVELINE'] == 1):
endif; 

/* emergency_call */
  $values['STAR_CMD_EMERGENT_NUM_1'] = $_POST['emergency_call1'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_1='".$values['STAR_CMD_EMERGENT_NUM_1']."'";
  $values['STAR_CMD_EMERGENT_NUM_2'] = $_POST['emergency_call2'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_2='".$values['STAR_CMD_EMERGENT_NUM_2']."'";
  $values['STAR_CMD_EMERGENT_NUM_3'] = $_POST['emergency_call3'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_3='".$values['STAR_CMD_EMERGENT_NUM_3']."'";
  $values['STAR_CMD_EMERGENT_NUM_4'] = $_POST['emergency_call4'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_4='".$values['STAR_CMD_EMERGENT_NUM_4']."'";
  $values['STAR_CMD_EMERGENT_NUM_5'] = $_POST['emergency_call5'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_5='".$values['STAR_CMD_EMERGENT_NUM_5']."'";
  $values['STAR_CMD_EMERGENT_NUM_6'] = $_POST['emergency_call6'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_6='".$values['STAR_CMD_EMERGENT_NUM_6']."'";
  $values['STAR_CMD_EMERGENT_NUM_7'] = $_POST['emergency_call7'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_7='".$values['STAR_CMD_EMERGENT_NUM_7']."'";
  $values['STAR_CMD_EMERGENT_NUM_8'] = $_POST['emergency_call8'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_8='".$values['STAR_CMD_EMERGENT_NUM_8']."'";
  $values['STAR_CMD_EMERGENT_NUM_9'] = $_POST['emergency_call9'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_9='".$values['STAR_CMD_EMERGENT_NUM_9']."'";
  $values['STAR_CMD_EMERGENT_NUM_10'] = $_POST['emergency_call10'] ;
  $updatesql.=",STAR_CMD_EMERGENT_NUM_10='".$values['STAR_CMD_EMERGENT_NUM_10']."'";
...
if($values['TELPORT'] >= 5): 
  ...
  $values['O_L5_DISABLE_OUT'] = $_POST['line5_fw_to_pstn']=='on'?'0':'1';
  $updatesql.=",O_L5_DISABLE_OUT='".$values['O_L5_DISABLE_OUT']."'";
if($values['O_L5_DISABLE_OUT'] == 0):
  ...
  $values['O_L5_DISABLE_IN'] = $_POST['line5_fw_to_voip']=='on'?'0':'1';
  $updatesql.=",O_L5_DISABLE_IN='".$values['O_L5_DISABLE_IN']."'";
if($values['O_L5_DISABLE_IN'] == 0):
...
if($values['TELPORT'] < 4): 
  $values['O_L5_VOIP_ANSWER_T'] = $_POST['line5_voip_answer_time'] ;
  $updatesql.=",O_L5_VOIP_ANSWER_T='".$values['O_L5_VOIP_ANSWER_T']."'";
endif; 
endif; 
if($values['TELPORT'] >= 6): 
endif; 
  $values['O_L6_DISABLE_OUT'] = $_POST['line6_fw_to_pstn']=='on'?'0':'1';
  $updatesql.=",O_L6_DISABLE_OUT='".$values['O_L6_DISABLE_OUT']."'";
if($values['O_L6_DISABLE_OUT'] == 0):
  ...
  $values['O_L6_DISABLE_IN'] = $_POST['line6_fw_to_voip']=='on'?'0':'1';
  $updatesql.=",O_L6_DISABLE_IN='".$values['O_L6_DISABLE_IN']."'";
if($values['O_L6_DISABLE_IN'] == 0):
...
if($values['TELPORT'] < 4): 
  $values['O_L6_VOIP_ANSWER_T'] = $_POST['line6_voip_answer_time'] ;
  $updatesql.=",O_L6_VOIP_ANSWER_T='".$values['O_L6_VOIP_ANSWER_T']."'";
endif; 
endif; 
if($values['TELPORT'] >= 7): 
endif; 
  $values['O_L7_DISABLE_OUT'] = $_POST['line7_fw_to_pstn']=='on'?'0':'1';
  $updatesql.=",O_L7_DISABLE_OUT='".$values['O_L7_DISABLE_OUT']."'";
if($values['O_L7_DISABLE_OUT'] == 0):
  ...
  $values['O_L7_DISABLE_IN'] = $_POST['line7_fw_to_voip']=='on'?'0':'1';
  $updatesql.=",O_L7_DISABLE_IN='".$values['O_L7_DISABLE_IN']."'";
if($values['O_L7_DISABLE_IN'] == 0):
...
if($values['TELPORT'] < 4): 
  $values['O_L7_VOIP_ANSWER_T'] = $_POST['line7_voip_answer_time'] ;
  $updatesql.=",O_L7_VOIP_ANSWER_T='".$values['O_L7_VOIP_ANSWER_T']."'";
endif; 
endif; 
if($values['TELPORT'] >= 8): 
endif; 
  $values['O_L8_DISABLE_OUT'] = $_POST['line8_fw_to_pstn']=='on'?'0':'1';
  $updatesql.=",O_L8_DISABLE_OUT='".$values['O_L8_DISABLE_OUT']."'";
if($values['O_L8_DISABLE_OUT'] == 0):
  ...
  $values['O_L8_DISABLE_IN'] = $_POST['line8_fw_to_voip']=='on'?'0':'1';
  $updatesql.=",O_L8_DISABLE_IN='".$values['O_L8_DISABLE_IN']."'";
if($values['O_L8_DISABLE_IN'] == 0):
...
if($values['TELPORT'] < 4): 
  $values['O_L8_VOIP_ANSWER_T'] = $_POST['line8_voip_answer_time'] ;
  $updatesql.=",O_L8_VOIP_ANSWER_T='".$values['O_L8_VOIP_ANSWER_T']."'";
endif; 
endif; 
 ...
 /*codec*/  
  ...
  $insertsql.=",LIVELINE";
  $insertsql2.="','".$values['LIVELINE'];
  $insertsql.=",HOOK_MODE";
  $insertsql2.="','".$values['HOOK_MODE'];
  $insertsql.=",PSTN_RING_LINE";
  $insertsql2.="','".$values['PSTN_RING_LINE'];  

  $insertsql.=",STAR_CMD_START_VOIP_DIAL";
  $insertsql2.="','".$values['STAR_CMD_START_VOIP_DIAL'];
  $insertsql.=",STAR_CMD_SWITCH_TO_PSTN";
  $insertsql2.="','".$values['STAR_CMD_SWITCH_TO_PSTN'];
  $insertsql.=",S_L1_DFC";
  $insertsql2.="','".$values['S_L1_DFC'];
  $insertsql.=",L1_VOIP_DIGITS";
  $insertsql2.="','".$values['L1_VOIP_DIGITS'];
  $insertsql.=",S_L2_DFC";
  $insertsql2.="','".$values['S_L2_DFC'];
  $insertsql.=",L2_VOIP_DIGITS";
  $insertsql2.="','".$values['L2_VOIP_DIGITS'];
  $insertsql.=",S_L3_DFC";
  $insertsql2.="','".$values['S_L3_DFC'];
  $insertsql.=",S_L4_DFC";
  $insertsql2.="','".$values['S_L4_DFC'];
  $insertsql.=",L1_PSTN_RING";
  $insertsql2.="','".$values['L1_PSTN_RING'];
  $insertsql.=",L2_PSTN_RING";
  $insertsql2.="','".$values['L2_PSTN_RING'];

/* emergent call */
  $insertsql.=",STAR_CMD_EMERGENT_NUM_1";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_1'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_2";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_2'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_3";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_3'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_4";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_4'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_5";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_5'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_6";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_6'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_7";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_7'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_8";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_8'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_9";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_9'];
  $insertsql.=",STAR_CMD_EMERGENT_NUM_10";
  $insertsql2.="','".$values['STAR_CMD_EMERGENT_NUM_10'];
...
/* o? */
  ...
  $insertsql.=",O_L5_DISABLE_OUT";
  $insertsql2.="','".$values['O_L5_DISABLE_OUT'];
  ...
  $insertsql.=",O_L5_DISABLE_IN";
  $insertsql2.="','".$values['O_L5_DISABLE_IN'];
  ...
  $insertsql.=",O_L5_VOIP_ANSWER_T";
  $insertsql2.="','".$values['O_L5_VOIP_ANSWER_T'];
  $insertsql.=",O_L6_DISABLE_OUT";
  $insertsql2.="','".$values['O_L6_DISABLE_OUT'];
  ...
  $insertsql.=",O_L6_DISABLE_IN";
  $insertsql2.="','".$values['O_L6_DISABLE_IN'];
  ...
  $insertsql.=",O_L6_VOIP_ANSWER_T";
  $insertsql2.="','".$values['O_L6_VOIP_ANSWER_T'];
  $insertsql.=",O_L7_DISABLE_OUT";
  $insertsql2.="','".$values['O_L7_DISABLE_OUT'];
  ...
  $insertsql.=",O_L7_DISABLE_IN";
  $insertsql2.="','".$values['O_L7_DISABLE_IN'];
  ...
  $insertsql.=",O_L7_VOIP_ANSWER_T";
  $insertsql2.="','".$values['O_L7_VOIP_ANSWER_T'];
  $insertsql.=",O_L8_DISABLE_OUT";
  $insertsql2.="','".$values['O_L8_DISABLE_OUT'];
  ...
  $insertsql.=",O_L8_DISABLE_IN";
  $insertsql2.="','".$values['O_L8_DISABLE_IN'];
  ...
  $insertsql.=",O_L8_VOIP_ANSWER_T";
  $insertsql2.="','".$values['O_L8_VOIP_ANSWER_T'];  
